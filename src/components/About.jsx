        ...
        <section id='about' className='text-white body-font'>
            <div className='container px-5 py-24 mx-auto'>
                <div className='flex flex-col text-center w-full mb-20'>
                    <h1 data-aos='fade-up' data-aos-delay='300' className='sm:text-3xl text-3xl font-bold title-font mb-4 text-white'>About</h1>
                ...
                <div data-aos='fade-up' data-aos-delay='500' className='flex flex-wrap -m-4 text-center'>
                    <div className='p-4 md:w-1/4 sm:w-1/2 w-full'>
                     <div className='border-2 border-blue-200 px-4 py-6 rounded-lg'>
                        <h2 className='title-font font-medium text-3xl text-white'>+10 ans</h2>
                    ...
                    <div className='p-4 md:w-1/4 sm:w-1/2 w-full'>
                     <div className='border-2 border-blue-200 px-4 py-6 rounded-lg'>
                        <h2 className='title-font font-medium text-3xl text-white'>+1.5k</h2>
